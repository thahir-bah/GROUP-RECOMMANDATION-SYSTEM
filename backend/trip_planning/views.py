...
API_KEY = 'AIzaSyBftW5KTTToUJygMq5OnOxVujtnXooGvMs'
...
class ItemView(viewsets.ModelViewSet):
    ...
    # YOUTUBE
    @action(detail=False, url_path='youtube_search/(?P<query>[^/.]+)', methods=['get'])
    def youtube_search(self, request, query=None):
        try:
            ...
            return Response(data=videos, status=status.HTTP_200_OK)
