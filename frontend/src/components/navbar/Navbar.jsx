...
function Navbar(props) {
    ...
    if (location.pathname === "/" || location.pathname.includes("/blog" )  || location.pathname.includes("/feed" ) || location.pathname === "/travel" || location.pathname === "/profile") {
            ...
            <nav className={transparent}>
                <div className="container">
                    <Link className="navbar-brand" to="/">
                        ...
                        <span style={{ color: 'Blue', fontWeight: 'bold'}}>TRIP GURU</span>
                    </Link>
                    ...
                    <div className=" collapse navbar-collapse " id="navbarNavDropdown">
                        <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item">
                                <NavLink className="nav-link mx-2" to="/feed">Feeds</NavLink>
                            </li>
                            <li className="nav-item">
